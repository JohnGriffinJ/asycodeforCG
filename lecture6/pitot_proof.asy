...
point A = intersectionpoint(tang1[0], tang2[0]); dot("$A'$", A,NW);
...
draw(D--C,linewidth(1.3));
draw(B--C, linewidth(1.3));
draw(A--D, dashed + red);

line DA_0 = line(D,false, rotate(-30)*A);
//draw(DA_0, linewidth(1.3));

point A_0 = intersectionpoint(tang2[0],DA_0); dot("$A$", A_0, NE);
draw(D--A_0, linewidth(1.3));
draw(A--A_0, linewidth(1.3));
